...
typedef struct {
   ElType contents[CAPL]; /* memori tempat penyimpan elemen (container) */
} ListPos;
/* Indeks yang digunakan [0..CAPL-1] */
...
/*    Pembacaan diulangi sampai didapat n yang benar yaitu 0 <= n <= CAPL */
/*    Jika n tidak valid, tidak diberikan pesan kesalahan */
/* 2. Jika 0 < n <= CAPL; Lakukan n kali: 
